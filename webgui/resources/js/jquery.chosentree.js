...
//console.log("treeparams.selected id(" + node.id + ") direct (" + direct + ") has_children(" + node.has_children + ")");
...
/*
            ...
            for (var id in selectedNodes) {
              ...
              if (choices) {choices.prepend(choice.append(span).append(close));}
            }
...
*/
            ...
            chosentree.value = selectedNodes;
  ...
  $.fn.selectedNodes = function(){
    return $.extend(true, {}, selectedNodes);
  };
