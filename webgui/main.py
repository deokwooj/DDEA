...
from influx_reader import read_sensor_data
from ddea_proc import ddea_process
import mytool as mt
import pickle, logging, logging.handlers, SocketServer, struct, traceback
...
if __name__ == '__main__':
    ...
    try:
        ...
        BaseHTTPServer\
            .HTTPServer(('0.0.0.0', BASE_HTTP_PORT), DDEARequestHandler)\
            .serve_forever()
