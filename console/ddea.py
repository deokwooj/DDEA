...
#ANS_START_T = utc.localize(dt.datetime(2011, 5, 22, 0))
#ANS_END_T = utc.localize(dt.datetime(2012, 12, 31, 0))

ANS_START_T = utc.localize(dt.datetime(2012, 1, 1, 0))
ANS_END_T = utc.localize(dt.datetime(2012, 1, 7, 0))
