...
PROC_OUT_DIR = '/adsc/bigdata/output_data/sdh/ProcOut'
DATA_DIR = '/adsc/bigdata/input_data/sdh/Binfiles/'
WEATHER_DIR = '/adsc/bigdata/input_data/sdh/weather/sdh_'
FIG_DIR = '/adsc/bigdata/output_data/sdh/Analysis'
FL_EXT = '.bin'
